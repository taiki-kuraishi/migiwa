...
// One row per stretch of a single activity. `activity_key` is application_id when present, else name:
// Discord marks activity.id as unstable, so it is never used for identity.
