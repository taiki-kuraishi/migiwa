...
// GUILD_CREATE / GUILD_DELETE go through reduceGuildCreate() / reduceGuildDelete() in ./guild instead.
// Reason: reduceGuildCreate needs disconnected_at and returns a guild upsert alongside its SessionOp[].
// Reason: reduceGuildDelete sits beside it because both are guild-lifecycle rules.
