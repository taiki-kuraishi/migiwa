/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: ba435817107289af5a3cce3ebda548ed)
// Runtime types generated with workerd@1.20260828.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	DISCORD_GUILD_IDS: string;
	DISCORD_BOT_TOKEN: string;
	BOT: DurableObjectNamespace<import("./dist/entry").BotObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/entry");
		durableNamespaces: "BotObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_GUILD_IDS" | "DISCORD_BOT_TOKEN">> {}
}
declare module "*.sql" {
	const value: string;
