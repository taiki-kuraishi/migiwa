...
// Besides user tables, sqlite_master lists sqlite_sequence, __drizzle_migrations and workerd's
// `_cf_*` internals; user tables are what remains after filtering these.
